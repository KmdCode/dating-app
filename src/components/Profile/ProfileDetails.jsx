...
const ProfileDetails = () => {
  ...
  return (
    <div className="profile-details bg-blue-100 shadow-md rounded-lg p-4 mb-4">
      ...
      <button className="self-start bg-blue-500 text-white py-2 px-4 ml-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
        Delete Profile
      </button>
